...
import { Menu, X, MapPin, Users, ClipboardList, LogOut, Clock } from 'lucide-react'
...
const menuItems = [
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* drawer */}
      <div className={`fixed top-0 left-0 h-full w-64 bg-white shadow-lg z-30 transform transition-transform duration-300 ${
